...
export const useGameModes = () => {
	...
	const data: MappedContainer<Mode> = {
		classic: {
			...
			firstFailMsg: 'За каждый правильный ответ отсчёт вопросов начинается с начала. Отвечайте неправильно, чтобы победить!',
			timerMul: 1
		},
		downstream: {
			id: 'downstream',
			...
			firstFailMsg: 'За каждый неправильный ответ отсчёт вопросов начинается с начала. Отвечайте правильно, чтобы победить!',
